...
if not defined UE_ROOT (
	if exist "E:\UE_5.8\Engine\Build\BatchFiles\RunUAT.bat" set "UE_ROOT=E:\UE_5.8"
)
if not defined UE_ROOT (
	if exist "D:\UE_5.8\Engine\Build\BatchFiles\RunUAT.bat" set "UE_ROOT=D:\UE_5.8"
)
if not defined UE_ROOT (
	if exist "%ProgramFiles%\Epic Games\UE_5.8\Engine\Build\BatchFiles\RunUAT.bat" (
